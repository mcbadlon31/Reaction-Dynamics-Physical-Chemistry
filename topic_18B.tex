...
% ===========================================================================
% Slide: Topic 18B Summary
% ===========================================================================
\begin{frame}{Topic 18B: Key Takeaways}

\textbf{Essential Equations:}
\begin{itemize}\itemsep=2pt
    \item \textbf{Diffusion-limited rate:} $k_d = 4\pi R D N_A$ (Smoluchowski)
    \item \textbf{Overall rate:} $\frac{1}{k} = \frac{1}{k_d} + \frac{1}{k_a}$ (encounter + activation)
    \item \textbf{Cage effect:} $\eta = \frac{k_{\text{cage}}}{k_{\text{cage}} + k_{\text{sep}}}$ (geminate pairs)
    \item \textbf{Viscosity dependence:} $k \propto \frac{T}{\eta}$ (Stokes-Einstein)
\end{itemize}

\vspace{0.2cm}
\textbf{When diffusion controls the rate:}
\begin{itemize}\itemsep=2pt
    \item[✓] Solution reactions (always important!)
    \item[✓] Fast reactions ($E_a < 20$ kJ/mol)
    \item[✓] Radical recombinations (barrierless)
    \item[✗] \textbf{NOT} for gas-phase (use collision theory)
    \item[✗] \textbf{NOT} when $k_a \ll k_d$ (activation-limited)
\end{itemize}

\vspace{0.2cm}
\textbf{Key Insight:} In solution, molecules must find each other before they can react!
