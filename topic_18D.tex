...
% ===========================================================================
% Slide: Practice Problem 4 - Part 1
% ===========================================================================
...
\begin{enumerate}[a)]\itemsep=2pt
    ...
    \item Estimate the effective tunneling distance if barrier width is 0.5 Å
    \item Would D + D$_2$ → D$_2$ + D show larger or smaller difference?
\end{enumerate}
...
\begin{itemize}\itemsep=2pt
    ...
    \item[(b)] Reduces effective barrier by $\sim 8$ kJ/mol (20\%)
    \item[(c)] Smaller - heavier mass reduces tunneling
\end{itemize}

\end{frame}

% ===========================================================================
% Slide: Practice Problem 4 - Part 2 (Tunneling Equation)
% ===========================================================================
\begin{frame}{Practice Problem 4 - Tunneling Equation}
\small

\textbf{Tunneling probability:}

\[ P_{\text{tunnel}} \propto \exp\left(-\frac{\sqrt{2m\Delta E} \cdot d}{\hbar}\right) \]

where:
\begin{itemize}\itemsep=2pt
    \item $m$ = particle mass
    \item $\Delta E$ = barrier height above particle energy
    \item $d$ = barrier width
\end{itemize}

\vspace{0.2cm}
\textbf{Isotope effect:}

For D vs H: $m_D = 2m_H$, so:
\[ \frac{P_{\text{tunnel,D}}}{P_{\text{tunnel,H}}} \propto \exp\left(-d\sqrt{m_D}/\hbar\right) / \exp\left(-d\sqrt{m_H}/\hbar\right) = e^{-(\sqrt{2}-1)d\sqrt{m_H}/\hbar} \approx 0.24 \]

Tunneling probability decreases by factor of $\sim$4 for deuterium.
...
% ===========================================================================
% Slide: Topic 18D Summary
% ===========================================================================
\begin{frame}{Topic 18D: Key Takeaways}

\textbf{Essential Concepts:}
\begin{itemize}\itemsep=2pt
    \item \textbf{Molecular beams:} Single-collision conditions reveal reaction dynamics
    \item \textbf{Differential cross-section:} $\sigma(\theta)$ → angular distribution of products
    \item \textbf{PES:} Multi-dimensional energy landscape guides reactive trajectories
    \item \textbf{Polanyi's Rules:} $E_{\text{trans}}$ vs $E_{\text{vib}}$ effectiveness depends on barrier type
\end{itemize}

\vspace{0.2cm}
\textbf{Key Techniques:}
\begin{itemize}\itemsep=2pt
    \item[✓] Molecular beam experiments (state-to-state chemistry)
    \item[✓] Classical trajectory calculations (Newton's equations on PES)
    \item[✓] Quantum scattering (for light atoms, tunneling)
    \item[✓] Newton diagrams (velocity vector analysis)
\end{itemize}

\vspace{0.2cm}
\textbf{Key Insight:} \textit{Where} energy is placed matters as much as \textit{how much}!
